    ...
    <>
      ...
      <div className="body_container">
        ...
        <div className="mission_container">
          <h3 className="mission">Sứ mệnh</h3>
          <h4 className="mission_reference">
            Kiến tạo công nghệ giáo dục, phát triển nhân lực tinh hoa từ Đại học
            FPT
          </h4>
          <div className="mission_content">
            <a className="mission_content_element" href="/">
              <p className="section-background__container-mission-item-header">
                Sản phẩm
              </p>
              <p className="section-background__container-mission-item-icon">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 38.32 43.35"
                >
                  <defs></defs>
                  <g id="Layer_2" data-name="Layer 2">
                    <g id="Layer_1-2" data-name="Layer 1">
                      <path
                        className="cls-1"
                        d="M17.38,8.67A.63.63,0,0,0,16.75,8h-7a.64.64,0,0,0,0,1.27h7a.63.63,0,0,0,.63-.63Z"
                      ></path>
                      <path
                        className="cls-1"
                        d="M16.75,4.65h-7a.63.63,0,0,0-.63.63.64.64,0,0,0,.63.64h7a.64.64,0,0,0,.63-.64.63.63,0,0,0-.63-.63Z"
                      ></path>
                      <path
                        className="cls-1"
                        d="M37.68,37.53a.64.64,0,0,0,.64-.63V9.69a3.12,3.12,0,0,0-.92-2.22L30.85.92A3.12,3.12,0,0,0,28.63,0H7.5A3.55,3.55,0,0,0,4,3.56v9.07H2.78A2.79,2.79,0,0,0,0,15.41V35.93A3.08,3.08,0,0,0,3.09,39H4v.79A3.56,3.56,0,0,0,7.5,43.35H35.18a3.15,3.15,0,0,0,3.14-3.15v-.33a.64.64,0,0,0-.64-.64.64.64,0,0,0-.63.64v.33a1.88,1.88,0,0,1-1.87,1.88H7.5A2.29,2.29,0,0,1,5.22,39.8V39H23.67a3.08,3.08,0,0,0,3.09-3.08V20a3.09,3.09,0,0,0-3.09-3.09H11.33a.64.64,0,0,0-.64.63.64.64,0,0,0,.64.64H23.67A1.81,1.81,0,0,1,25.49,20V35.93a1.81,1.81,0,0,1-1.82,1.81H3.09a1.81,1.81,0,0,1-1.82-1.81V17.74a2.77,2.77,0,0,0,1.51.45H8.29a.64.64,0,0,0,.64-.64.64.64,0,0,0-.64-.63H5.22V3.56A2.29,2.29,0,0,1,7.5,1.27H28.63a1.75,1.75,0,0,1,.4,0V7.1a2.19,2.19,0,0,0,2.19,2.18H37a1.92,1.92,0,0,1,0,.41V36.9a.63.63,0,0,0,.63.63ZM2.78,16.92a1.51,1.51,0,1,1,0-3H4v3ZM30.3,7.1V2.17L36.15,8H31.22a.92.92,0,0,1-.92-.91Z"
                      ></path>
                      <path
                        className="cls-1"
                        d="M6.17,24.8v6.33A1.61,1.61,0,0,0,7,32.51l5.48,3.16a1.61,1.61,0,0,0,1.59,0l5.48-3.16a1.62,1.62,0,0,0,.8-1.38V24.8a1.62,1.62,0,0,0-.8-1.38L14,20.26a1.61,1.61,0,0,0-1.59,0L7,23.42a1.61,1.61,0,0,0-.79,1.38ZM7.6,31.41a.33.33,0,0,1-.16-.28V25.35l5.16,3v6Zm11.27,0-5,2.88v-6l5.17-3v5.78a.34.34,0,0,1-.17.28Zm-5.8-10a.33.33,0,0,1,.33,0l5,2.89-5.16,3-5.17-3Z"
                      ></path>
                    </g>
                  </g>
                </svg>
              </p>
              <p className="section-background__container-mission-item-footer">
                Tìm hiểu các khóa học chủ lực kết hợp công nghệ và sáng tạo
              </p>
            </a>
            <a className="mission_content_element" href="/">
              <p className="section-background__container-mission-item-header">
              ...
              <p className="section-background__container-mission-item-icon">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 37.83 39.94"
                >
                  <g id="Layer_2" data-name="Layer 2">
                    <g id="Layer_1-2" data-name="Layer 1">
                      <path
                        className="cls-1"
                        d="M30.56,10A4.16,4.16,0,1,0,26.4,5.82,4.16,4.16,0,0,0,30.56,10Zm0-6.65a2.5,2.5,0,1,1-2.49,2.49,2.5,2.5,0,0,1,2.49-2.49Z"
                      ></path>
                      <path
                        className="cls-1"
                        d="M37.81,23.82l-1.07-8.53a4.16,4.16,0,0,0-4.12-3.64H28.51a4.24,4.24,0,0,0-1.39.24.83.83,0,0,0-.5,1.07.82.82,0,0,0,1.06.5,2.47,2.47,0,0,1,.83-.15h4.11a2.49,2.49,0,0,1,2.47,2.19L36.16,24a.81.81,0,0,1-.2.65.83.83,0,0,1-.63.28h-.61a.84.84,0,0,0-.83.77l-.77,10.88H28l-.6-8.38a.82.82,0,0,0-.89-.77.83.83,0,0,0-.77.89l.65,9.15a.84.84,0,0,0,.83.77h6.66a.82.82,0,0,0,.83-.77l.78-10.88a2.51,2.51,0,0,0,2.31-2.8Z"
                      ></path>
                      <path
                        className="cls-1"
                        d="M11.3,27.65a.82.82,0,0,0-.89.77l-.59,8.19H4.71L3.94,25.73A.84.84,0,0,0,3.11,25H2.5a.83.83,0,0,1-.63-.28.81.81,0,0,1-.2-.65L2.74,15.5a2.49,2.49,0,0,1,2.47-2.19H9.32a2.21,2.21,0,0,1,.63.1.84.84,0,0,0,1-.6.83.83,0,0,0-.6-1,4.09,4.09,0,0,0-1-.15H5.21a4.16,4.16,0,0,0-4.12,3.64L0,23.82a2.49,2.49,0,0,0,2.31,2.8L3.11,37.5a.82.82,0,0,0,.83.77h6.65a.82.82,0,0,0,.83-.77l.65-9a.84.84,0,0,0-.77-.89Z"
                      ></path>
                      <path
                        className="cls-1"
                        d="M7.27,10A4.16,4.16,0,1,0,3.11,5.82,4.16,4.16,0,0,0,7.27,10Zm0-6.65a2.5,2.5,0,1,1-2.5,2.49,2.5,2.5,0,0,1,2.5-2.49Z"
                      ></path>
                      <path
                        className="cls-1"
                        d="M26.24,23.69,25.14,14a4.41,4.41,0,0,0-4.24-4H16.65a4.4,4.4,0,0,0-4.24,4L11.3,23.69a2.82,2.82,0,0,0,.69,2.2,2.41,2.41,0,0,0,1.71.84l.91,12.44a.84.84,0,0,0,.83.77H22.1a.83.83,0,0,0,.83-.77l.92-12.44a2.45,2.45,0,0,0,1.71-.84,2.81,2.81,0,0,0,.68-2.2Zm-1.92,1.09a.82.82,0,0,1-.61.29h-.64a.84.84,0,0,0-.83.77l-.91,12.43H16.22L15.3,25.84a.83.83,0,0,0-.83-.77h-.63a.82.82,0,0,1-.61-.29,1.14,1.14,0,0,1-.27-.9l1.1-9.67a2.74,2.74,0,0,1,2.59-2.56H20.9a2.74,2.74,0,0,1,2.59,2.56l1.1,9.67a1.14,1.14,0,0,1-.27.9Z"
                      ></path>
                      <path
                        className="cls-1"
                        d="M18.77,8.32a4.16,4.16,0,1,0-4.16-4.16,4.17,4.17,0,0,0,4.16,4.16Zm0-6.66a2.5,2.5,0,1,1-2.49,2.5,2.5,2.5,0,0,1,2.49-2.5Z"
                      ></path>
                    </g>
                  </g>
                </svg>
              ...
              <p className="section-background__container-mission-item-footer">
                Khám phá giảng viên và văn hóa học tập tại Đại học FPT
              </p>
            </a>
            <a className="mission_content_element" href="/">
              {" "}
                ...
                >
                  <g id="Layer_2" data-name="Layer 2">
                    <g id="Layer_1-2" data-name="Layer 1">
                      <path
                        className="cls-1"
                        d="M40.93,40.32H37V16.22a.61.61,0,0,0-.61-.61H29.87a.61.61,0,0,0-.61.61v24.1H24.63V23.37a.61.61,0,0,0-.61-.61h-6.5a.61.61,0,0,0-.61.61v17H12.27V26.62a.61.61,0,0,0-.61-.61H5.16a.62.62,0,0,0-.61.61v13.7H.61a.61.61,0,1,0,0,1.22H40.93a.61.61,0,0,0,0-1.22Zm-35.16,0V27.23h5.29V40.32Zm12.36,0V24h5.28V40.32Zm12.35,0V16.83h5.29V40.32Z"
                      ></path>
                      <path
                        className="cls-1"
                        d="M2.56,24h.06a46.83,46.83,0,0,0,13-2.79,51.24,51.24,0,0,0,11.43-5.75.61.61,0,0,0,.16-.85.6.6,0,0,0-.84-.16A49.88,49.88,0,0,1,15.23,20,45.35,45.35,0,0,1,2.58,22.76h0a.68.68,0,0,1-.69-.67.69.69,0,0,1,.67-.71A45,45,0,0,0,14.86,18.7,47.11,47.11,0,0,0,35.72,4a.62.62,0,0,0-.55-1l-2,.25a.69.69,0,0,1-.75-.52A.7.7,0,0,1,33,1.87l5.2-.65a.7.7,0,0,1,.78.69v5.2a.69.69,0,0,1-1.38,0V5.54a.62.62,0,0,0-1.09-.39,47.09,47.09,0,0,1-7.7,7.5.61.61,0,0,0-.11.86.6.6,0,0,0,.85.11A48.78,48.78,0,0,0,36.42,7.2a1.91,1.91,0,0,0,3.82-.09V1.91A1.9,1.9,0,0,0,39.59.48,2,2,0,0,0,38.09,0l-5.2.66a1.91,1.91,0,1,0,.47,3.79l.43-.06A46.2,46.2,0,0,1,14.45,17.56,44.29,44.29,0,0,1,2.5,20.16a1.92,1.92,0,0,0-1.85,2A1.9,1.9,0,0,0,2.56,24Z"
                      ></path>
                    </g>
                  </g>
                </svg>
              ...
              <p className="section-background__container-mission-item-footer">
                Khám phá cảm hứng và đóng góp xã hội cùng chúng tôi
              </p>
            </a>
            <a className="mission_content_element" href="/">
              {" "}
              <p className="section-background__container-mission-item-header">
                Nâng Niu Bộ Não Việt
              </p>
              <div className="section-background__container-mission-item-icon">
                <svg
                  version="1.1"
                  id="_x32_"
                  xmlns="http://www.w3.org/2000/svg"
                ...
                >
                  <g>
                    <path
                      className="st0"
                      d="M410.34,153.043c-1.278-1.293-2.712-2.477-4.288-3.527l-1.615-0.337c-0.846-0.368-1.52-0.972-1.96-1.702
        		...
        		c4.225,3.652,7.815,8.622,10.073,14.447c1.489,3.887,2.398,8.152,2.398,12.604C382.379,183.12,379.879,190.958,374.023,198.037z"
                    ...
                    <path
                      className="st0"
                      d="M428.699,66.574C396.943,29.442,349.183,4.155,287.986,0.462C283.008,0.156,278.054,0,273.147,0
        ...
        {/* Block2: Khóa nổi bật */}
        <div className="section_outstanding_courses_container">
          <div className="section_outstanding_courses_header">
            <h2 className="section_outstanding_courses_title">
              Khóa Học Nổi Bật
            </h2>
            <p className="section_outstanding_courses_introduce">
              Khám phá các kỹ năng được tìm kiếm nhiều nhất/hàng đầu trong tuần
              này và bắt đầu việc học của bạn ngay hôm nay
            </p>
          </div>
